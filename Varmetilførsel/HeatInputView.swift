        ...
        GeometryReader { geometry in
            ...
            //    }
                ...
                ZStack {
                    ...
                    // --- START ENDRING ---
                                        .contentShape(Rectangle()) // Gjør at også tomrommet i layouten (særlig på iPad) fanger opp trykk
                                        .onTapGesture {
                                            // Hvis skuffen er åpen og man trykker i "løse luften" (f.eks. under knappene), lukk skuffen
                                            if focusedField != nil {
